...
async def get_movie_details(movie_id: int):
    """Fetch detailed movie metadata including trailers, cast, and providers."""
    # 👇 Added watch/providers
    return await tmdb_get_request(f"/movie/{movie_id}", {"append_to_response": "videos,credits,watch/providers"})
